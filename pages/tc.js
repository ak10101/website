...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Terms and conditions - Corner Cafe</title>
      </Head>
      <section className="container mx-auto w-full">
        <article className="prose ">
          ...
          <p>
            ...
            individually and collectively refer to the users. This page states
            the Terms and Conditions under which you may visit this website
            cornercafe.shop. Please read this page carefully. If you do not
            accept the Terms and Conditions stated here, we would request you to
            exit this site. The business, any of its business divisions and / or
            its subsidiaries, associate companies or subsidiaries to
            subsidiaries or such other investment companies (in India or abroad)
            reserve their respective rights to revise these Terms and Conditions
          ...
          <p>
            ...
            claims, actions and/or demands and/or liabilities and/or losses
            and/or damages whatsoever arising from or resulting from their use
            of <strong> Corner Cafe</strong> their breach of the terms .
          </p>
          <h3>LIABILITY</h3>
          <p>
            User agrees that neither <strong> Corner Cafe</strong> nor its group
            companies, directors, officers or employee shall be liable for any
            direct or/and indirect or/and incidental or/and special or/and
            ...
            has been advised of the possibility of such damages. User further
            agrees that <strong> Corner Cafe</strong> shall not be liable for
            any damages arising from interruption, suspension or termination of
            ...
            advertent. User agrees that <strong> Corner Cafe</strong> shall not
            be responsible or liable to user, or anyone, for the statements or
          ...
          <p>
            ...
            or any parties, organizations or entities associated with the
